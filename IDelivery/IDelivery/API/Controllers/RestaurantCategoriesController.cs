...
[ApiController, Route("api/restaurant-categories")]
public class RestaurantCategoriesController(ICatalogService catalog) : ControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List() => Ok(await catalog.GetRestaurantCategoriesAsync());
}
